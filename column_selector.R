...
column.selector <- function(year){
  ...
  if (year=="1415"){
    ...
    hhold_col <- c("SERNUM","HRPNUM", "HHINC", "HBENINC", "HEARNS", "NHBENINC","HHLDR01","HHLDR02","HHLDR03","HHLDR04","HHLDR05","HHLDR06","HHLDR07",
                   "HHLDR08","HHLDR09","HHLDR10","HHLDR11","HHLDR12","HHLDR13","HHLDR14","HHLDR97","HHSTAT", "DEPCHLDH",
                   "DISCHHA1","DISCHHC1","DISWHHA1","DISWHHC1","GBHSCOST", "GIVEHELP", "GVTREGN", "GVTREGNO", "PTENTYP2", "BEDROOM", "BURDEN", "GROSS4","HHRENT")
